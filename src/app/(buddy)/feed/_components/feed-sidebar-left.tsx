      ...
      <div className={cardClass}>
        ...
        <ul className="space-y-1">
          <li className="relative mb-6 flex items-center justify-between">
            <Link
              href="#0"
              className="text-buddy-text hover:text-buddy-accent flex items-center gap-3 font-medium transition-colors duration-200 ease-in-out"
            >
            ...
            <span className="bg-buddy-green absolute right-0 rounded px-2 py-0.5 text-xs font-medium text-white">
              New
            </span>
          </li>
          <li className="relative mb-6 flex items-center justify-between">
          ...
          <div key={p.name} className="mb-4 flex items-center justify-between gap-2 last:mb-0">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-buddy-muted truncate text-xs">{p.role}</p>
              </div>
            </div>
            <Link
              href="#0"
