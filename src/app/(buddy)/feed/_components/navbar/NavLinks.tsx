...
const NavLinks = () => {
  ...
  return (
    <nav className="flex shrink-0 items-center gap-6">
      ...
      {/* Friends / Network */}
      <Link href="/network" className={navItemClass("/network")}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="20"
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            type="button"
            className={cn(
              "group relative cursor-pointer rounded-lg p-2 transition-all duration-200 hover:bg-black/5 dark:hover:bg-white/10",
              "text-buddy-text/60 hover:text-buddy-accent",
            )}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <PopoverContent
          align="center"
          className="border-buddy-border bg-buddy-surface w-[400px] p-0"
        >
          <NotificationPanel />
        </PopoverContent>
      </Popover>
      ...
      <Link href="/messages" className={navItemClass("/messages")}>
        <div className="relative">
          ...
          <span className="bg-buddy-accent absolute -top-2 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full px-1 text-[10px] font-medium text-white">
            2
          </span>
        </div>
      </Link>
      ...
      {/* Profile */}
      <div className="border-buddy-divider ml-3 border-l pl-4">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Image
                ...
                width={40}
                height={40}
                className="dark:ring-buddy-dark-surface rounded-full object-cover ring-2 ring-white"
              />

              <div className="text-left">
                <p className="text-buddy-heading text-sm font-medium">Dylan Field</p>

                <div className="text-buddy-muted group-hover:text-primary flex items-center gap-1 text-xs transition-colors">
                  Account
                  <svg
                    width="10"
                    height="6"
          ...
          <DropdownMenuContent
            align="end"
            className="border-buddy-border bg-buddy-surface text-buddy-text dark:text-buddy-heading w-72"
          >
            <div className="flex items-center gap-3 p-2">
              ...
              <div className="flex flex-col gap-4">
                <p className="text-buddy-heading font-poppins leading-0 font-semibold">
                  Dylan Field
                </p>
                <Link href={"#"} className="text-buddy-accent font-poppins text-xs font-medium">
                  view profile
                </Link>
              </div>
            </div>

            <DropdownMenuSeparator className="bg-buddy-divider" />
              ...
              >
                <span className="bg-buddy-accent/10 mr-2 inline-block w-fit rounded-full p-[11px]">
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 18 19"
                    className="transition-all duration-200 group-hover:[&>path]:stroke-(--color-buddy-accent)"
                  >
                    <path
                      stroke="currentColor"
                      fill="none"
                ...
                >
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 4 10"
                    className="text-buddy-muted transition-all duration-200 group-hover:[&>path]:stroke-(--color-buddy-accent)"
                  >
                    <path
                      stroke="currentColor"
                      fill="none"
